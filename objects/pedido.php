...
class Pedido {
    ...
    function create() {
        ...
        $query = "INSERT INTO " . $this->table_name . "
                SET
                    id_cliente=:id_cliente, id_pro=:id_pro, producto=:producto, prefijos=:prefijos, cantidad=:cantidad, fecha=:fecha, numero_pedido=:numero_pedido, estado=:estado, tipo_solicitud=:tipo_solicitud, estado_boton='preparacion', detalle=:detalle, tipo_producto=:tipo_producto, mesa=:mesa, mesero=:id_mesero";
