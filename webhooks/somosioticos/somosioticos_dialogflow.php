...
$user = isset($_SERVER['PHP_AUTH_USER']) ? $_SERVER['PHP_AUTH_USER'] : 'default_user';
$password = isset($_SERVER['PHP_AUTH_PW']) ? $_SERVER['PHP_AUTH_PW'] : 'default_password';
...
function credenciales($expectedUser, $expectedPass)
{
    $receivedUser = isset($_SERVER['PHP_AUTH_USER']) ? $_SERVER['PHP_AUTH_USER'] : 'default_user';
    $receivedPass = isset($_SERVER['PHP_AUTH_PW']) ? $_SERVER['PHP_AUTH_PW'] : 'default_password';

    if ($expectedUser != $receivedUser || $expectedPass != $receivedPass) {
        $response = [
            'fulfillmentText' => 'Acceso no autorizado',
            'fulfillmentMessages' => [
                [
                    'text' => [
