...
if(isset($data->numero_pedido)) {
    ...
    try {
        ...
        $query = "UPDATE pedidos SET estado_boton = 'entregado' WHERE numero_pedido = :numero_pedido";
        ...
        if ($mesa) {
            ...
            $update_mesa_query = "UPDATE mesas SET estado = 'entregado', id_pedido = :numero_pedido WHERE numero_mesa = :numero_mesa";
