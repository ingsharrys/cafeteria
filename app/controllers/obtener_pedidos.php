...
$query_turnos = "SELECT p.numero_pedido, p.detalle, p.fecha, c.cliente, c.celular, c.email, c.direccion, p.estado, p.tipo_solicitud, p.estado_boton, p.mesa, t.turno
                 ...
                 ORDER BY 
                     t.turno ASC, FIELD(p.estado_boton, 'preparacion', 'espera', 'entregado'), p.fecha DESC";
...
// A�0�9adir detalles adicionales a cada turno
...
// A�0�9adir el estado de pago para cada mesa
