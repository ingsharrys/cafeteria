...
if(isset($data->numero_pedido)) {
    ...
    try {
        ...
        $query = "UPDATE pedidos SET estado_boton = 'espera' WHERE numero_pedido = :numero_pedido";
        ...
        if ($mesa) {
            ...
            $update_mesa_query = "UPDATE mesas SET estado = 'espera', id_pedido = :numero_pedido WHERE numero_mesa = :numero_mesa";
