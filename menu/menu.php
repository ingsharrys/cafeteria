...
<div class="container mt-5">
    ...
    <div class="d-flex align-items-center">
                        ...
                        <?php if ($turnoData['estado'] === 'preparacion'): ?>
                        ...
                        <?php elseif ($turnoData['estado'] === 'espera'): ?>
                        ...
                        <?php endif; ?>
                        <?php if (!empty($turnoData['estado'])): ?>
                            <span class="badge badge-pill badge-dark ms-2"><?php echo mapEstadoLabel($turnoData['estado']); ?></span>
                        <?php endif; ?>
                    </div>
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <?php if ($pedido['estado'] === 'entregado'): ?>
                            <span class="badge badge-pill badge-success ms-2">Pedido entregado</span>
                        <?php endif; ?>
                    </div>
