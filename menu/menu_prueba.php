...
//$celular = substr($telefono, 3); // Eliminar los primeros tres caracteres
//echo $celular;
...
date_default_timezone_set('America/Bogota');  // Definir la zona horaria de Colombia
...
if ($cliente) {
    $id_cliente = $cliente['id']; // Asignar el id del cliente
    ...
    $pedidosPendientes = []; // No hay pedidos si el cliente no existe
}
...
<header class="d-flex justify-content-center py-3">
    <img src="http://localhost/cafeteria-pombo/public/img/logo-pideyapp.png" style="width: 140px;height:56px" alt="Logotipo" class="header-logo">
</header>

<div class="container mt-5">
    <h4 class="text-center mb-4">Pedidos Pendientes para Hoy</h4>
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <?php if (!empty($pedido['estado'])): ?>
                                    <span class="badge badge-pill badge-dark ms-2"><?php echo mapEstadoLabel($pedido['estado']); ?></span>
                                <?php endif; ?>
                            </div>
                            <div class="d-flex align-items-center">
                                <!-- Mostrar el estado del pedido con el bombillo correspondiente -->
                                <?php if ($pedido['estado'] === 'preparacion'): ?>
                                    <span class="bombillo-rojo mr-3"><i class="fas fa-lightbulb"></i></span>
                                    <a href="https://wa.me/573174742056?text=Hola,%20me%20gustaría%20agregar%20o%20quitar%20algo%20del%20pedido%20con%20turno%20<?php echo $pedido['turno']; ?>" class="btn btn-outline-danger btn-sm">Modificar Pedido</a>
                                <?php elseif ($pedido['estado'] === 'espera'): ?>
                                    <span class="bombillo-naranja mr-3"><i class="fas fa-lightbulb"></i></span>
                                    <a href="https://wa.me/573174742056?text=Hola,%20me%20gustaría%20agregar%20o%20quitar%20algo%20del%20pedido%20con%20turno%20<?php echo $pedido['turno']; ?>" class="btn btn-outline-warning btn-sm">Modificar Pedido</a>
...
<div class="modal fade" id="orderSentModal" tabindex="-1" role="dialog" aria-labelledby="orderSentModalLabel" aria-hidden="true">
 ...
 <!-- Contenedor para el número de pedido -->
            </div>
